...
Utility functions related to file IO for the MASC PCR pipeline.
...
def writeCsvReport(idx_lut, set_of_primer_sets, combined_bins, params):
    ''' Write a general informational output report in csv format.
    '''
    output_fp = params['output_basename'] + '_masc_report.csv'
...
def writeIdtXslxFile(idx_lut, set_of_primer_sets, combined_bins, params):
    ...
    for bin_idx, set_idx in enumerate(set_of_primer_sets):
        ...
        cur_row += 1
    wb.save(params['output_basename'] + '_masc_order.xlsx')
